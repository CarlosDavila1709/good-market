...
public final class SearchOrdersByCriteriaQuery implements Query{
	...
	public SearchOrdersByCriteriaQuery(List<HashMap<String, String>> filters, Optional<String> orderBy,
