...
public final class SearchCustomersByCriteriaQuery implements Query{
	...
	public SearchCustomersByCriteriaQuery(List<HashMap<String, String>> filters, Optional<String> orderBy,
