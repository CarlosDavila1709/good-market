...
public final class SearchProductsCatalogByCriteriaQuery implements Query {
	...
	public SearchProductsCatalogByCriteriaQuery(List<HashMap<String, String>> filters, Optional<String> orderBy,
