<h3 class="font-sans text-gray-800 text-center text-3xl mb-10">Tiendas existentes</h3>
...
<script>
        ...
        fetch(encodeURI(url))
            ...
            .then(function (courses) {
                ...
                courses.forEach(function (course) {
                    ...
                    courseRow.appendChild(tableCellFor(course.nameCommercial));
                    courseRow.appendChild(tableCellFor(course.address));
    ...
    function addFilter(e) {
        ...
        const filterRowTemplate = "<div class=\"filter-row\">\n" +
                                  ...
                                  "            <option value=\"nameCommercial\">Nombre</option>\n" +
                                  "            <option value=\"address\">Duración</option>\n" +
                                  "        </select>\n" +
    ...
    function filterCourses(e) {
        ...
        const url = "http://localhost:8091/grocerys?" + urlParts.join("&");
...
<script>
    addCoursesList("http://localhost:8091/grocerys");
</script>
